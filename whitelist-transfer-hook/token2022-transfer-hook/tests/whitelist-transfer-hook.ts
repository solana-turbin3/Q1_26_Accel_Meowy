...
describe("whitelist-transfer-hook", () => {
  ...
  const [walletWhitelistPDA] = anchor.web3.PublicKey.findProgramAddressSync(
  ...
  it("Add user to whitelist", async () => {
    const tx = await program.methods
      ...
      .accountsPartial({
        ...
        whitelistEntry: walletWhitelistPDA,
  ...
  it("Transfer Hook with Extra Account Meta", async () => {
    ...
    // Use createTransferCheckedWithTransferHookInstruction to auto-resolve extra accounts
